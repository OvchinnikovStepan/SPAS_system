...
DETECTORS = {
    "avalanche": "detectors.avalanche_detector.avalanche_detector",
    "freezing": "detectors.freezing_detector.freezing_detector",
...
def routing_func(models: Dict[str, Dict[str, Any]]) -> Dict[str, Union[pd.Series, pd.DataFrame]]:
    ...
    for detector_type, params in models.items():
        try:
            ...
            results[detector_type] = detector_func(**params)
