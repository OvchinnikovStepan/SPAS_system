from app.tests.detectors_tests.outlier_detector_test import test_api_outlier_detector
from app.tests.detectors_tests.avalanche_detector_test import test_api_avalanche_detector
from app.tests.detectors_tests.freezing_detector_test import test_api_freezing_detector
