...
Перед запуском необходимо отформатировать название файла: удалить часть 
.example из имени файла и названия папки .env.example, находящегося в корневой папке
...
(при смене порта запуска api изменить 8000 на подходящий)